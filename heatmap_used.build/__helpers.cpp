...
PyObject *CALL_METHOD_WITH_ARGS5( PyObject *source, PyObject *attr_name, PyObject **args )
{
    ...
    if ( type->tp_getattro == PyObject_GenericGetAttr )
    {
        ...
        {
            CHECK_OBJECT( descr );
            return CALL_FUNCTION_WITH_ARGS5(
                descr,
                args
            );
        }
...
PyObject *CALL_METHOD_WITH_ARGS6( PyObject *source, PyObject *attr_name, PyObject **args )
{
    ...
    if ( type->tp_getattro == PyObject_GenericGetAttr )
    {
        ...
        {
            CHECK_OBJECT( descr );
            return CALL_FUNCTION_WITH_ARGS6(
                descr,
                args
            );
        }
...
PyObject *CALL_METHOD_WITH_ARGS14( PyObject *source, PyObject *attr_name, PyObject **args )
{
    ...
    if ( type->tp_getattro == PyObject_GenericGetAttr )
    {
        ...
        {
            CHECK_OBJECT( descr );
            return CALL_FUNCTION_WITH_ARGS14(
                descr,
                args
            );
        }
...
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    ...
    { (char *)"backports.configparser", MOD_INIT_NAME( backports$configparser ), 0, 0, NUITKA_PACKAGE_FLAG },
    { (char *)"backports.configparser.helpers", MOD_INIT_NAME( backports$configparser$helpers ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { (char *)"configparser", MOD_INIT_NAME( configparser ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { (char *)"numpy.distutils", NULL, 1578477, 710, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.__config__", NULL, 1579187, 1750, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.__version__", NULL, 1580937, 390, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.ccompiler", NULL, 1581327, 24258, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command", NULL, 1605585, 1366, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.command.autodist", NULL, 1606951, 2759, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.bdist_rpm", NULL, 1609710, 1146, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build", NULL, 1610856, 2579, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_clib", NULL, 1613435, 8908, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_ext", NULL, 1622343, 13827, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_py", NULL, 1636170, 1657, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_scripts", NULL, 1637827, 1988, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_src", NULL, 1639815, 23190, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.config", NULL, 1663005, 15094, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.config_compiler", NULL, 1678099, 5840, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.develop", NULL, 1683939, 1101, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.egg_info", NULL, 1685040, 1388, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install", NULL, 1686428, 2745, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_clib", NULL, 1689173, 2203, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_data", NULL, 1691376, 1293, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_headers", NULL, 1692669, 1343, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.sdist", NULL, 1694012, 1293, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.compat", NULL, 1695305, 574, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.conv_template", NULL, 1695879, 9678, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.core", NULL, 1705557, 5989, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.cpuinfo", NULL, 1711546, 43236, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.environment", NULL, 1754782, 3454, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.exec_command", NULL, 1758236, 9353, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.extension", NULL, 1767589, 2664, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.fcompiler", NULL, 1770253, 33721, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.from_template", NULL, 1803974, 8473, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.info", NULL, 1812447, 375, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.lib2def", NULL, 1812822, 3987, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.log", NULL, 1816809, 3062, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.mingw32ccompiler", NULL, 1819871, 18258, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.misc_util", NULL, 1838129, 77244, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.npy_pkg_config", NULL, 1915373, 15174, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.numpy_distribution", NULL, 1930547, 1070, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.system_info", NULL, 1931617, 79811, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.unixccompiler", NULL, 2011428, 4113, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.dual", MOD_INIT_NAME( numpy$dual ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"numpy.f2py", NULL, 2015541, 2406, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.f2py.__version__", NULL, 2017947, 477, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.auxfuncs", NULL, 2018424, 30691, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.capi_maps", NULL, 2049115, 22174, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.cb_rules", NULL, 2071289, 16750, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.cfuncs", NULL, 2088039, 37536, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.common_rules", NULL, 2125575, 5635, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.crackfortran", NULL, 2131210, 88582, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.diagnose", NULL, 2219792, 4316, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f2py2e", NULL, 2224108, 20591, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f2py_testing", NULL, 2244699, 1770, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f90mod_rules", NULL, 2246469, 8683, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.func2subr", NULL, 2255152, 7949, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.rules", NULL, 2263101, 38639, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.use_rules", NULL, 2301740, 3723, NUITKA_BYTECODE_FLAG },
    ...
    { (char *)"numpy.testing", NULL, 2305463, 784, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.testing.decorators", NULL, 2306247, 9329, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.noseclasses", NULL, 2315576, 11019, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.nosetester", NULL, 2326595, 16205, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.utils", NULL, 2342800, 71619, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.version", MOD_INIT_NAME( numpy$version ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"pkg_resources", NULL, 2414419, 118376, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"pkg_resources.extern", NULL, 2532795, 2931, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"pkg_resources.py31compat", NULL, 2535726, 798, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools", NULL, 2536524, 6736, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.archive_util", NULL, 2543260, 6133, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command", NULL, 2549393, 878, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.command.bdist_egg", NULL, 2550271, 17838, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.bdist_rpm", NULL, 2568109, 1894, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.develop", NULL, 2570003, 7857, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.easy_install", NULL, 2577860, 79324, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.egg_info", NULL, 2657184, 25844, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.install", NULL, 2683028, 4915, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.install_scripts", NULL, 2687943, 2868, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.py36compat", NULL, 2690811, 5506, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.sdist", NULL, 2696317, 7895, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.setopt", NULL, 2704212, 6018, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.config", NULL, 2710230, 16740, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.depends", NULL, 2726970, 6474, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.dist", NULL, 2733444, 39787, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.extension", NULL, 2773231, 2392, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.extern", NULL, 2775623, 327, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.glob", NULL, 2775950, 4777, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.monkey", NULL, 2780727, 6302, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.namespaces", NULL, 2787029, 4989, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.package_index", NULL, 2792018, 39781, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py26compat", NULL, 2831799, 1277, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py27compat", NULL, 2833076, 1025, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py31compat", NULL, 2834101, 2346, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py33compat", NULL, 2836447, 1482, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py36compat", NULL, 2837929, 2853, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.sandbox", NULL, 2840782, 18962, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.ssl_support", NULL, 2859744, 8308, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.unicode_utils", NULL, 2868052, 1452, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.version", NULL, 2869504, 311, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.windows_support", NULL, 2869815, 1254, NUITKA_BYTECODE_FLAG },
